...
function LoginContent() {
  ...
  return (
    ...
    >
      ...
      {/* Title */}
      <h1 className="font-heading mb-1.5 text-center text-[32px] leading-none font-bold tracking-[0.05em] text-[var(--foreground)]">
        Torchlight
      </h1>
      <p className="font-heading mb-8 text-[9px] tracking-[0.22em] text-[var(--muted-foreground)] uppercase">
      ...
      {error && (
        ...
        >
          <AlertDescription className="text-[12px] leading-relaxed text-[var(--destructive)] italic">
      ...
      <Card className="worn-border card-surface animate-mist-rise w-full max-w-[360px] gap-0 px-8 py-7">
        <CardHeader className="px-0">
          {/* Decorative rule */}
          <div className="font-mono mb-4.5 text-center text-[8px] tracking-[0.18em] text-[var(--muted-foreground)]">
            ✦ ─── ARCHIVUM TORCHLIGHT ─── ✦
          </div>
        ...
        <CardContent className="px-0">
          <Button
            ...
            className="border-primary bg-primary text-primary-foreground hover:bg-primary/80 h-auto w-full gap-2.5 rounded-[1px] px-5 py-3 text-[11px] font-semibold tracking-[0.14em] shadow-[var(--glow-blood),0_2px_8px_rgba(0,0,0,0.5)] transition-all duration-[var(--duration-base)] ease-[var(--ease-ritual)]"
          >
