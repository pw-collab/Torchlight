  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon
        render={
          <HugeiconsIcon icon={UnfoldMoreIcon} strokeWidth={2} className="cn-select-trigger-icon pointer-events-none" />
        }
      />
    </SelectPrimitive.Trigger>
  )
...
function SelectItem({
  ...
  return (
    ...
    >
      ...
      >
        <HugeiconsIcon icon={Tick02Icon} strokeWidth={2} className="cn-select-item-indicator-icon pointer-events-none" />
      </SelectPrimitive.ItemIndicator>
    </SelectPrimitive.Item>
  )
}
