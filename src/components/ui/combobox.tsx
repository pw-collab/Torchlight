...
function ComboboxTrigger({
  ...
  return (
    ...
    >
      {children}
      <HugeiconsIcon icon={ArrowDown01Icon} strokeWidth={2} className="cn-combobox-trigger-icon pointer-events-none" />
    </ComboboxPrimitive.Trigger>
  )
}
...
function ComboboxClear({ className, ...props }: ComboboxPrimitive.Clear.Props) {
  return (
    <ComboboxPrimitive.Clear
      ...
      {...props}
    >
      <HugeiconsIcon icon={Cancel01Icon} strokeWidth={2} className="cn-combobox-clear-icon pointer-events-none" />
    </ComboboxPrimitive.Clear>
  )
}
...
function ComboboxItem({
  ...
  return (
    ...
    >
      ...
      >
        <HugeiconsIcon icon={Tick02Icon} strokeWidth={2} className="cn-combobox-item-indicator-icon pointer-events-none" />
      </ComboboxPrimitive.ItemIndicator>
    </ComboboxPrimitive.Item>
  )
}
  ...
  return (
    ...
    >
      ...
      {showRemove && (
        ...
        >
          <HugeiconsIcon icon={Cancel01Icon} strokeWidth={2} className="cn-combobox-chip-indicator-icon pointer-events-none" />
        </ComboboxPrimitive.ChipRemove>
      )}
    </ComboboxPrimitive.Chip>
  )
